...
a9 <- expression(paste("NH"[4]^"+", "-N (mg g"^-1,")"))
a10 <- expression(paste("NO"[3]^"-", "-N (mg g"^-1,")"))
a11 <- expression(paste("pH"))
a12 <- expression(paste("SOC (mg kg"^-1,")"))
a13 <- expression(paste("Total N (mg kg"^-1,")"))
...
p1 <- ggplot(data_with_se[which(data_with_se$Time %in% c(5,15,30,193)),], aes(x = as.factor(Time), y = mean_cumulative_CO2, fill = Plastic, alpha=Nitrogen)) +
  ...
  #geom_point(aes(y = cumulative_CO2), position = position_jitterdodge(jitter.width = 0.1, dodge.width=0.95),
  #         color = "black", size = 1) +
  ...
  #geom_text(aes(label=letters, y= mean_cumulative_CO2 + se_cumulative_CO2+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "A") +
  geom_label(aes(label=letters, y= mean_cumulative_CO2 - se_cumulative_CO2+200), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA, show.legend = F)



p1
ggsave(p1, file="Figures/cumulative_CO2.png",width = 10, height = 3.5, dpi = 300)
...
p1 <- ggplot(data_with_se, aes(x = Time, y = mean_cumulative_CO2, color=Plastic, linetype=Nitrogen, group = interaction(Plastic, Nitrogen))) +
  ...
  #geom_errorbar(aes(ymin = mean_cumulative_CO2 - se_cumulative_CO2, ymax = mean_cumulative_CO2 + se_cumulative_CO2), linetype=1, width=0) +
  #geom_point(aes(y = cumulative_CO2), position = position_jitterdodge(jitter.width = 0.1, dodge.width=0.95),
  #         color = "black", size = 1) +
  #facet_wrap(.~Time, nrow=1) +
  ...
  #geom_text(aes(label=letters, y= mean_cumulative_CO2 + se_cumulative_CO2+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "A") #+
#geom_label(aes(label=letters, y= mean_cumulative_CO2 - se_cumulative_CO2-20), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA)
...
p1 <- ggplot(data_with_se[which(data_with_se$Time %in% c(5,15,30,193)),], aes(x = as.factor(Time), y = mean_cumulative_CO2_plastic, fill = Plastic, alpha=Nitrogen)) +
  ...
  geom_errorbar(aes(ymin = mean_cumulative_CO2_plastic - se_cumulative_CO2_plastic, ymax = mean_cumulative_CO2_plastic + se_cumulative_CO2_plastic),
                position = position_dodge(width=0.95), width = 0.25) +
  #geom_point(aes(y = cumulative_CO2_plastic), position = position_jitterdodge(jitter.width = 0.1, dodge.width=0.95),
  #         color = "black", size = 1) +
  #facet_wrap(.~Time, nrow=1) +
  labs(x = "Incubation time (d)",
       y = dat_names[2]) +
  ...
  theme_bw() + theme(panel.border = element_rect(colour = "black"), panel.grid.major = element_blank(),
                     panel.grid.minor = element_blank(), #axis.line = element_line(colour = "black"),
                     axis.text.y = element_text(size=13),text = element_text(size = 15))  +   
  #geom_text(aes(label=letters, y= mean_cumulative_CO2_plastic + se_cumulative_CO2_plastic+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "B") +
  geom_label(aes(label=letters, y= mean_cumulative_CO2_plastic - se_cumulative_CO2_plastic+100), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA, show.legend = F)



p1
ggsave(p1, file="Figures/cumulative_CO2_plastic.png",width = 10, height = 3.5, dpi = 300)
...
p1 <- ggplot(data_with_se, aes(x = Time, y = mean_cumulative_CO2_plastic, color=Plastic, linetype=Nitrogen, group = interaction(Plastic, Nitrogen))) +
  ...
  scale_color_manual(values = colplas) + 
  scale_linetype_manual(values = c("dashed", "solid")) + 
  #geom_errorbar(aes(ymin = mean_cumulative_CO2_plastic - se_cumulative_CO2_plastic, ymax = mean_cumulative_CO2_plastic + se_cumulative_CO2_plastic), linetype=1, width=0) +
  #geom_point(aes(y = cumulative_CO2_plastic), position = position_jitterdodge(jitter.width = 0.1, dodge.width=0.95),
  #         color = "black", size = 1) +
  #facet_wrap(.~Time, nrow=1) +
  ...
  #geom_text(aes(label=letters, y= mean_cumulative_CO2_plastic + se_cumulative_CO2_plastic+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "B") #+
#geom_label(aes(label=letters, y= mean_cumulative_CO2_plastic - se_cumulative_CO2_plastic-20), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA)
...
p1 <- ggplot(data_with_se[which(data_with_se$Time %in% c(5,15,30,193)),], aes(x = as.factor(Time), y = mean_cumulative_CO2_native, fill = Plastic, alpha=Nitrogen)) +
  ...
  geom_errorbar(aes(ymin = mean_cumulative_CO2_native - se_cumulative_CO2_native, ymax = mean_cumulative_CO2_native + se_cumulative_CO2_native),
                position = position_dodge(width=0.95), width = 0.25) +
  #geom_point(aes(y = cumulative_CO2_native), position = position_jitterdodge(jitter.width = 0.1, dodge.width=0.95),
  #         color = "black", size = 1) +
  #facet_wrap(.~Time, nrow=1) +
  labs(x = "Incubation time (d)",
       y = dat_names[3]) +
  ...
  theme_bw() + theme(panel.border = element_rect(colour = "black"), panel.grid.major = element_blank(),
                     panel.grid.minor = element_blank(), #axis.line = element_line(colour = "black"),
                     axis.text.y = element_text(size=13),text = element_text(size = 15))  +   
  #geom_text(aes(label=letters, y= mean_cumulative_CO2_native + se_cumulative_CO2_native+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "C") +
  geom_label(aes(label=letters, y= mean_cumulative_CO2_native - se_cumulative_CO2_native+100), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA, show.legend = F)



p1
ggsave(p1, file="Figures/cumulative_CO2_native.png",width = 10, height = 3.5, dpi = 300)
...
p1 <- ggplot(data_with_se, aes(x = Time, y = mean_cumulative_CO2_native, color=Plastic, linetype=Nitrogen, group = interaction(Plastic, Nitrogen))) +
  ...
  scale_color_manual(values = colplas) + 
  scale_linetype_manual(values = c("dashed", "solid")) + 
  #geom_errorbar(aes(ymin = mean_cumulative_CO2_native - se_cumulative_CO2_native, ymax = mean_cumulative_CO2_native + se_cumulative_CO2_native), linetype=1, width=0) +
  #geom_point(aes(y = cumulative_CO2_native), position = position_jitterdodge(jitter.width = 0.1, dodge.width=0.95),
  #         color = "black", size = 1) +
  #facet_wrap(.~Time, nrow=1) +
  ...
  #geom_text(aes(label=letters, y= mean_cumulative_CO2_native + se_cumulative_CO2_native+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "C") #+
#geom_label(aes(label=letters, y= mean_cumulative_CO2_native - se_cumulative_CO2_native-20), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA)
...
p1 <- ggplot(data_with_se[which(data_with_se$Time %in% c(5,15,30,193)),], aes(x = as.factor(Time), y = mean_cumulative_priming, fill = Plastic, alpha=Nitrogen)) +
  ...
  geom_errorbar(aes(ymin = mean_cumulative_priming - se_cumulative_priming, ymax = mean_cumulative_priming + se_cumulative_priming),
                position = position_dodge(width=0.95), width = 0.25) +
  #geom_point(aes(y = cumulative_priming), position = position_jitterdodge(jitter.width = 0.1, dodge.width=0.95),
  #         color = "black", size = 1) +
  #facet_wrap(.~Time, nrow=1) +
  labs(x = "Incubation time (d)",
  ...
  theme_bw() + theme(panel.border = element_rect(colour = "black"), panel.grid.major = element_blank(),
                     panel.grid.minor = element_blank(), #axis.line = element_line(colour = "black"),
                     axis.text.y = element_text(size=13),text = element_text(size = 15))  +   
  #geom_text(aes(label=letters, y= mean_cumulative_priming + se_cumulative_priming+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "B") +
  geom_label(aes(label=letters, y= mean_cumulative_priming - se_cumulative_priming+50), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA, show.legend = F)



p1
ggsave(p1, file="Figures/cumulative_priming.png",width = 10, height = 3.5, dpi = 300)
...
p1 <- ggplot(data_with_se, aes(x = Time, y = mean_cumulative_priming, color=Plastic, linetype=Nitrogen, group = interaction(Plastic, Nitrogen))) +
  ...
  scale_linetype_manual(values = c("dashed", "solid")) + 
  #geom_errorbar(aes(ymin = mean_cumulative_priming - se_cumulative_priming, ymax = mean_cumulative_priming + se_cumulative_priming), linetype=1, width=0) +
  #geom_point(aes(y = cumulative_priming), position = position_jitterdodge(jitter.width = 0.1, dodge.width=0.95),
  #         color = "black", size = 1) +
  #facet_wrap(.~Time, nrow=1) +
  ...
  #geom_text(aes(label=letters, y= mean_cumulative_priming + se_cumulative_priming+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "B") #+
#geom_label(aes(label=letters, y= mean_cumulative_priming - se_cumulative_priming-20), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA)
...
p1 <- ggplot(data_with_se[which(data_with_se$Time %in% c(5,15,30,193)),], aes(x = as.factor(Time), y = mean_cumulative_priming_relative, fill = Plastic, alpha=Nitrogen)) +
  ...
  theme_bw() + theme(panel.border = element_rect(colour = "black"), panel.grid.major = element_blank(),
                     panel.grid.minor = element_blank(), #axis.line = element_line(colour = "black"),
                     axis.text.y = element_text(size=13),text = element_text(size = 15))  +   
  #geom_text(aes(label=letters, y= mean_cumulative_priming_relative + se_cumulative_priming_relative+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "B") +
  geom_label(aes(label=letters, y= mean_cumulative_priming_relative - se_cumulative_priming_relative+20), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA, show.legend = F)



p1
ggsave(p1, file="Figures/cumulative_priming_relative.png",width = 10, height = 3.5, dpi = 300)
...
p1 <- ggplot(data_with_se, aes(x = Time, y = mean_cumulative_priming_relative, color=Plastic, linetype=Nitrogen, group = interaction(Plastic, Nitrogen))) +
  ...
  #geom_text(aes(label=letters, y= mean_cumulative_priming_relative + se_cumulative_priming_relative+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "B") #+
#geom_label(aes(label=letters, y= mean_cumulative_priming_relative - se_cumulative_priming_relative-20), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA)
...
p1 <- ggplot(data_with_se[which(data_with_se$Time %in% c(5,15,30,193)),], aes(x = as.factor(Time), y = mean_daily_CO2, fill = Plastic, alpha=Nitrogen)) +
  ...
  theme_bw() + theme(panel.border = element_rect(colour = "black"), panel.grid.major = element_blank(),
                     panel.grid.minor = element_blank(), #axis.line = element_line(colour = "black"),
                     axis.text.y = element_text(size=13),text = element_text(size = 15))  +   
  #geom_text(aes(label=letters, y= mean_daily_CO2 + se_daily_CO2+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "A") +
  geom_label(aes(label=letters, y= mean_daily_CO2 - se_daily_CO2+5), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA, show.legend = F)



p1
ggsave(p1, file="Figures/daily_CO2.png",width = 10, height = 3.5, dpi = 300)
...
p1 <- ggplot(data_with_se, aes(x = Time, y = mean_daily_CO2, color=Plastic, linetype=Nitrogen, group = interaction(Plastic, Nitrogen))) +
  ...
  #geom_text(aes(label=letters, y= mean_daily_CO2 + se_daily_CO2+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "A") #+
#geom_label(aes(label=letters, y= mean_daily_CO2 - se_daily_CO2-20), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA)



p1
ggsave(p1, file="Figures/daily_CO2_lineplot.png",width = 6, height = 4, dpi = 300)
...
p1 <- ggplot(data_with_se[which(data_with_se$Time %in% c(5,15,30,193)),], aes(x = as.factor(Time), y = mean_daily_CO2_plastic, fill = Plastic, alpha=Nitrogen)) +
  ...
  theme_bw() + theme(panel.border = element_rect(colour = "black"), panel.grid.major = element_blank(),
                     panel.grid.minor = element_blank(), #axis.line = element_line(colour = "black"),
                     axis.text.y = element_text(size=13),text = element_text(size = 15))  +   
  #geom_text(aes(label=letters, y= mean_daily_CO2_plastic + se_daily_CO2_plastic+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "B") +
...
p1
ggsave(p1, file="Figures/daily_CO2_plastic.png",width = 10, height = 3.5, dpi = 300)
...
p1 <- ggplot(data_with_se, aes(x = Time, y = mean_daily_CO2_plastic, color=Plastic, linetype=Nitrogen, group = interaction(Plastic, Nitrogen))) +
  ...
  #geom_text(aes(label=letters, y= mean_daily_CO2_plastic + se_daily_CO2_plastic+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "B") #+
#geom_label(aes(label=letters, y= mean_daily_CO2_plastic - se_daily_CO2_plastic-20), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA)
...
p1 <- ggplot(data_with_se[which(data_with_se$Time %in% c(5,15,30,193)),], aes(x = as.factor(Time), y = mean_daily_CO2_native, fill = Plastic, alpha=Nitrogen)) +
  ...
  theme_bw() + theme(panel.border = element_rect(colour = "black"), panel.grid.major = element_blank(),
                     panel.grid.minor = element_blank(), #axis.line = element_line(colour = "black"),
                     axis.text.y = element_text(size=13),text = element_text(size = 15))  +   
  #geom_text(aes(label=letters, y= mean_daily_CO2_native + se_daily_CO2_native+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "C") +
  geom_label(aes(label=letters, y= mean_daily_CO2_native - se_daily_CO2_native+1.5), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA, show.legend = F)



p1
ggsave(p1, file="Figures/daily_CO2_native.png",width = 10, height = 3.5, dpi = 300)
...
p1 <- ggplot(data_with_se, aes(x = Time, y = mean_daily_CO2_native, color=Plastic, linetype=Nitrogen, group = interaction(Plastic, Nitrogen))) +
  ...
  #geom_text(aes(label=letters, y= mean_daily_CO2_native + se_daily_CO2_native+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "C") #+
#geom_label(aes(label=letters, y= mean_daily_CO2_native - se_daily_CO2_native-20), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA)
...
p1 <- ggplot(data_with_se[which(data_with_se$Time %in% c(5,15,30,193)),], aes(x = as.factor(Time), y = mean_priming, fill = Plastic, alpha=Nitrogen)) +
  ...
  geom_errorbar(aes(ymin = mean_priming - se_priming, ymax = mean_priming + se_priming),
                position = position_dodge(width=0.95), width = 0.25) +
  #geom_point(aes(y = priming), position = position_jitterdodge(jitter.width = 0.1, dodge.width=0.95),
  #         color = "black", size = 1) +
  #facet_wrap(.~Time, nrow=1) +
  labs(x = "Incubation time (d)",
  ...
  theme_bw() + theme(panel.border = element_rect(colour = "black"), panel.grid.major = element_blank(),
                     panel.grid.minor = element_blank(), #axis.line = element_line(colour = "black"),
                     axis.text.y = element_text(size=13),text = element_text(size = 15))  +   
  #geom_text(aes(label=letters, y= mean_priming + se_priming+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "A") +
  geom_label(aes(label=letters, y= mean_priming - se_priming+1.5), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA, show.legend = F)



p1
ggsave(p1, file="Figures/daily_priming.png",width = 10, height = 3.5, dpi = 300)
...
p1 <- ggplot(data_with_se, aes(x = Time, y = mean_priming, color=Plastic, linetype=Nitrogen, group = interaction(Plastic, Nitrogen))) +
  ...
  scale_color_manual(values = colplas[2:5]) + 
  scale_linetype_manual(values = c("dashed", "solid")) + 
  #geom_errorbar(aes(ymin = mean_priming - se_priming, ymax = mean_priming + se_priming), linetype=1, width=0) +
  #geom_point(aes(y = priming), position = position_jitterdodge(jitter.width = 0.1, dodge.width=0.95),
  #         color = "black", size = 1) +
  #facet_wrap(.~Time, nrow=1) +
  ...
  #geom_text(aes(label=letters, y= mean_priming + se_priming+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "A") #+
#geom_label(aes(label=letters, y= mean_priming - se_priming-20), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA)



p1
ggsave(p1, file="Figures/daily_priming_lineplot.png",width = 9, height = 3, dpi = 300)
...
p1 <- ggplot(data_with_se[which(data_with_se$Time %in% c(5,15,30,193)),], aes(x = as.factor(Time), y = mean_priming_relative, fill = Plastic, alpha=Nitrogen)) +
  ...
  theme_bw() + theme(panel.border = element_rect(colour = "black"), panel.grid.major = element_blank(),
                     panel.grid.minor = element_blank(), #axis.line = element_line(colour = "black"),
                     axis.text.y = element_text(size=13),text = element_text(size = 15))  +   
  #geom_text(aes(label=letters, y= mean_priming_relative + se_priming_relative+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "A") +
  geom_label(aes(label=letters, y= mean_priming_relative - se_priming_relative+0.3), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA, show.legend = F)



p1
ggsave(p1, file="Figures/daily_priming_relative.png",width = 10, height = 3.5, dpi = 300)
...
p1 <- ggplot(data_with_se, aes(x = Time, y = mean_priming_relative, color=Plastic, linetype=Nitrogen, group = interaction(Plastic, Nitrogen))) +
  ...
  #geom_text(aes(label=letters, y= mean_priming_relative + se_priming_relative+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "A") #+
#geom_label(aes(label=letters, y= mean_priming_relative - se_priming_relative-20), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA)
...
# Create the bar diagram with data points and error bars
p1 <- ggplot(data_with_se, aes(x = Time, y = mean_SOC, fill = Plastic, alpha=Nitrogen)) +
  geom_bar(stat = "identity", position = position_dodge(width=0.95), width=0.95) +
  geom_errorbar(aes(ymin = mean_SOC - se_SOC, ymax = mean_SOC + se_SOC),
                position = position_dodge(width=0.95), width = 0.25) +
  #geom_point(aes(y = SOC), position = position_jitterdodge(jitter.width = 0.1, dodge.width=0.95),
  #         color = "black", size = 1) +
  #facet_wrap(.~Time, nrow=1) +
  ...
  theme_bw() + theme(panel.border = element_rect(colour = "black"), panel.grid.major = element_blank(),
                     panel.grid.minor = element_blank(), #axis.line = element_line(colour = "black"),
                     axis.text.y = element_text(size=13),text = element_text(size = 15))  +   
  #geom_text(aes(label=letters, y= mean_SOC + se_SOC+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "A") +
  geom_label(aes(label=letters, y= mean_SOC - se_SOC+0.4), position=position_dodge(width=0.95), 
             hjust=0.5,size=3, fontface="bold", label.size = NA, show.legend=F)



p1
ggsave(p1, file="Figures/SOC.png",width = 10, height = 3.5, dpi = 300)
...
# Create the bar diagram with data points and error bars
p1 <- ggplot(data_with_se, aes(x = Time, y = mean_SOC, color=Plastic, linetype=Nitrogen, group = interaction(Plastic, Nitrogen))) +
  geom_line(linewidth=1) +
  scale_color_manual(values = colplas) + 
  scale_linetype_manual(values = c("dashed", "solid")) + 
  ...
  #geom_text(aes(label=letters, y= mean_SOC + se_SOC+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "A") #+
#geom_label(aes(label=letters, y= mean_SOC - se_SOC-20), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA)
...
# Create the bar diagram with data points and error bars
p1 <- ggplot(data_with_se, aes(x = Time, y = mean_TN, fill = Plastic, alpha=Nitrogen)) +
  geom_bar(stat = "identity", position = position_dodge(width=0.95), width=0.95) +
  geom_errorbar(aes(ymin = mean_TN - se_TN, ymax = mean_TN + se_TN),
                position = position_dodge(width=0.95), width = 0.25) +
  ...
  theme_bw() + theme(panel.border = element_rect(colour = "black"), panel.grid.major = element_blank(),
                     panel.grid.minor = element_blank(), #axis.line = element_line(colour = "black"),
                     axis.text.y = element_text(size=13),text = element_text(size = 15))  +   
  #geom_text(aes(label=letters, y= mean_TN + se_TN+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "A") +
  geom_label(aes(label=letters, y= mean_TN - se_TN+0.02), position=position_dodge(width=0.95), 
             hjust=0.5,size=3, fontface="bold", label.size = NA, show.legend=F)



p1
ggsave(p1, file="Figures/TN.png",width = 10, height = 3.5, dpi = 300)
...
p1 <- ggplot(data_with_se, aes(x = Time, y = mean_TN, color=Plastic, linetype=Nitrogen, group = interaction(Plastic, Nitrogen))) +
  ...
  #geom_text(aes(label=letters, y= mean_TN + se_TN+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "B") #+
#geom_label(aes(label=letters, y= mean_TN - se_TN-20), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA)
...
p1 <- ggplot(data_with_se, aes(x = Time, y = mean_MBC, fill = Plastic, alpha=Nitrogen)) +
  ...
  theme_bw() + theme(panel.border = element_rect(colour = "black"), panel.grid.major = element_blank(),
                     panel.grid.minor = element_blank(), #axis.line = element_line(colour = "black"),
                     axis.text.y = element_text(size=13),text = element_text(size = 15))  +   
  #geom_text(aes(label=letters, y= mean_MBC + se_MBC+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "A") +
...
p1
ggsave(p1, file="Figures/MBC.png",width = 10, height = 3.5, dpi = 300)
...
p1 <- ggplot(data_with_se, aes(x = Time, y = mean_MBC, color=Plastic, linetype=Nitrogen, group = interaction(Plastic, Nitrogen))) +
  ...
  #geom_text(aes(label=letters, y= mean_MBC + se_MBC+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "A") #+
  #geom_label(aes(label=letters, y= mean_MBC - se_MBC-20), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA)
...
p1
ggsave(p1, file="Figures/DOC.png",width = 10, height = 3.5, dpi = 300)
...
p1 <- ggplot(data_with_se, aes(x = Time, y = mean_DOC, color=Plastic, linetype=Nitrogen, group = interaction(Plastic, Nitrogen))) +
  ...
  theme(panel.border = element_rect(colour = "black"), #panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), #axis.line = element_line(colour = "black"),
        axis.text.y = element_text(size=13),text = element_text(size = 15))  +   
  #geom_text(aes(label=letters, y= mean_DOC + se_DOC+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "B") #+
#geom_label(aes(label=letters, y= mean_DOC - se_DOC-20), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA)
...
p1
ggsave(p1, file="Figures/cacq.png",width = 10, height = 3.5, dpi = 300)
...
p1 <- ggplot(data_with_se, aes(x = Time, y = mean_cacq, color=Plastic, linetype=Nitrogen, group = interaction(Plastic, Nitrogen))) +
  ...
  theme(panel.border = element_rect(colour = "black"), #panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), #axis.line = element_line(colour = "black"),
        axis.text.y = element_text(size=13),text = element_text(size = 12))  +   
  #geom_text(aes(label=letters, y= mean_cacq + se_cacq+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "A") #+
#geom_label(aes(label=letters, y= mean_cacq - se_cacq-20), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA)
...
p1
ggsave(p1, file="Figures/LAP.png",width = 10, height = 3.5, dpi = 300)
...
p1 <- ggplot(data_with_se, aes(x = Time, y = mean_LAP, color=Plastic, linetype=Nitrogen, group = interaction(Plastic, Nitrogen))) +
  ...
  theme(panel.border = element_rect(colour = "black"), #panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), #axis.line = element_line(colour = "black"),
        axis.text.y = element_text(size=13),text = element_text(size = 15))  +   
  #geom_text(aes(label=letters, y= mean_LAP + se_LAP+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "B") #+
#geom_label(aes(label=letters, y= mean_LAP - se_LAP-20), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA)
...
p1
ggsave(p1, file="Figures/Ammonium.png",width = 10, height = 3.5, dpi = 300)
...
p1 <- ggplot(data_with_se, aes(x = Time, y = mean_Ammonium, color=Plastic, linetype=Nitrogen, group = interaction(Plastic, Nitrogen))) +
  ...
  theme(panel.border = element_rect(colour = "black"), #panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), #axis.line = element_line(colour = "black"),
        axis.text.y = element_text(size=13),text = element_text(size = 15))  +   
  #geom_text(aes(label=letters, y= mean_Ammonium + se_Ammonium+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "A") #+
#geom_label(aes(label=letters, y= mean_Ammonium - se_Ammonium-20), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA)
...
p1
ggsave(p1, file="Figures/Nitrate.png",width = 10, height = 3.5, dpi = 300)
...
p1 <- ggplot(data_with_se, aes(x = Time, y = mean_Nitrate, color=Plastic, linetype=Nitrogen, group = interaction(Plastic, Nitrogen))) +
  ...
  theme(panel.border = element_rect(colour = "black"), #panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), #axis.line = element_line(colour = "black"),
        axis.text.y = element_text(size=13),text = element_text(size = 15))  +   
  #geom_text(aes(label=letters, y= mean_Nitrate + se_Nitrate+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "B") #+
#geom_label(aes(label=letters, y= mean_Nitrate - se_Nitrate-20), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA)
...
p1 <- ggplot(data_with_se, aes(x = Time, y = mean_pH, fill = Plastic, alpha=Nitrogen)) +
  ...
  geom_label(aes(label=letters, y= mean_pH + se_pH+0.25), position=position_dodge(width=0.95), 
             hjust=0.5, vjust=0,size=3, fontface="bold", label.size = NA, show.legend = F)


p1
ggsave(p1, file="Figures/pH.png",width = 10, height = 3.5, dpi = 300)
...
p1 <- ggplot(data_with_se, aes(x = Time, y = mean_pH, color=Plastic, linetype=Nitrogen, group = interaction(Plastic, Nitrogen))) +
  ...
  theme(panel.border = element_rect(colour = "black"), #panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), #axis.line = element_line(colour = "black"),
        axis.text.y = element_text(size=13),text = element_text(size = 15))  +   
  #geom_text(aes(label=letters, y= mean_pH + se_pH+20), position=position_dodge(width=0.95), hjust=0.5,size=3)+
  labs(tag = "C") #+
#geom_label(aes(label=letters, y= mean_pH - se_pH-20), position=position_dodge(width=0.95), hjust=0.5,size=3, fontface="bold", label.size = NA)
